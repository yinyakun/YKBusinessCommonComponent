...
Pod::Spec.new do |s|
s.name             = 'YKBusinessCommonComponent'
s.version          = '0.0.1'
s.summary          = '发送邮件包含 附件'
...
s.homepage         = 'https://github.com/yinyakun/YKBusinessCommonComponent'
s.license          = { :type => 'MIT', :file => 'LICENSE' }
s.author           = { 'yinyakun' => 'yinyakun123@126.com' }
s.source           = { :git => 'https://github.com/yinyakun/YKBusinessCommonComponent.git', :tag => s.version.to_s }
